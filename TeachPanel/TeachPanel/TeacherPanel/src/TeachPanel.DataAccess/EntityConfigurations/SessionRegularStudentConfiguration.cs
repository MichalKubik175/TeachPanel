...
public sealed class SessionRegularStudentConfiguration : AuditEntityBaseConfiguration<SessionRegularStudent, Guid>
{
    public override void Configure(EntityTypeBuilder<SessionRegularStudent> builder)
    {
        ...
        builder.HasOne(x => x.Session)
            .WithMany(x => x.SessionRegularStudents)
