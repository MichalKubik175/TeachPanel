...
import { PlusOutlined, DeleteOutlined, ArrowLeftOutlined, SaveOutlined, EyeOutlined } from '@ant-design/icons';
...
const TableLayoutCreatePage = ({ onBack }) => {
  ...
  return (
    <div style={{ padding: '24px', maxWidth: '1200px', margin: '0 auto' }}>
      <div style={{ marginBottom: '24px' }}>
        ...
        <Title level={2}>Створити розкладку столів</Title>
      </div>
